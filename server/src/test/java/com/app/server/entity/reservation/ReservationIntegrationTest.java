...
public class ReservationIntegrationTest {
    ...
    public void getReservation_shouldReturnReservationDetails(){
        ...
        // Act
        ResponseEntity<Reservation> response = testRestTemplate.getForEntity("/api/reservation/{name}", Reservation.class, "ershad");

        // Assert
        Assertions.assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        Assertions.assertThat(response.getBody().getFirstName()).isEqualTo("ershad");
        Assertions.assertThat(response.getBody().getLastName()).isEqualTo("haq");
...
class SampleDataCLR implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        reservationRepository.save(new Reservation("ershad","haq"));
